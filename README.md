...
## General description
This project is part of the course 052497 - "NUMERICAL ANALYSIS FOR PARTIAL DIFFERENTIAL EQUATIONS" at Politecnico di Milano. Refer to `report.pdf` for a detailed explanation of the background and results related to this project.
